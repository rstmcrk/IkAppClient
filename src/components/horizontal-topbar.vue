  ...
  <header id="page-topbar">
    <div class="navbar-header">
      <div class="d-flex">
        ...
        <b-dropdown variant="black" class="dropdown-mega d-none d-lg-block ms-2" toggle-class="header-item"
          menu-class="dropdown-megamenu">
          <template v-slot:button-content>
            {{ ("navbar.dropdown.megamenu.text") }}
      ...
      <div class="d-flex">
        ...
        <b-dropdown class="d-none d-lg-inline-block noti-icon" menu-class="dropdown-menu-lg dropdown-menu-end" right
        ...
        <b-dropdown menu-class="dropdown-menu-lg p-0 dropdown-menu-end" toggle-class="header-item noti-icon"
          ...
          <template v-slot:button-content>
            ...
            <span class="badge bg-danger rounded-pill">{{
              ("navbar.dropdown.notification.badge")
            }}</span>
          </template>
