                  ...
                  <template v-for="(subitem, index) of item.subItems">
                    ...
                    <div v-if="item.subItems.length > 11" :key="index">
                      <div v-if="index % 3 == 0" class="row">
                        <div class="col-lg-4"><router-link class="dropdown-item side-nav-link-ref" :to="subitem.link">{{ (item.subItems[index].label)}}</router-link></div>
                        <div class="col-lg-4" v-if="item.subItems[index + 1].link"><router-link class="dropdown-item side-nav-link-ref" :to="item.subItems[index + 1].link">{{ (item.subItems[index + 1].label) }}</router-link></div>
                        <div class="col-lg-4" v-if="item.subItems[index + 2]"><router-link class="dropdown-item side-nav-link-ref" :to="item.subItems[index + 2].link">{{ (item.subItems[index + 2].label) }}</router-link></div> 
                      </div>
                    </div>
                            ...
                            <div class="dropdown-menu">
                              ...
                              >
                                <router-link
                                  ...
                                  >{{ (subSubSubitem.label) }}</router-link
                                >
                              </template>
                            </div>
                          </div>
